...
var Storage = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.json = proxy_1.ElasticProxy.new({
                            recursive: false,
                            get: function (path) {
    ...
    Storage.prototype.write = function (name, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs.writeFile(this.buddy.path(name), this.buddy.crypto.encrypt(data))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 5]);
                        _b = (_a = this.buddy.crypto).decrypt;
                        return [4 /*yield*/, fs.readFile(this.buddy.path(name))];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.mkdir(this.buddy.path(path))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
